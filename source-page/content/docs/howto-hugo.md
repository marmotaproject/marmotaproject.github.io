...
* Com a edição feita, digite `hugo -d ../`. Assim a estrutura da página estática em html/css/js, será gerado na pasta do projeto. Isto é, na pasta `marmota.github.io`.
